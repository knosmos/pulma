...
parser.add_argument('--cps', type=bool, default=True, help='Use CPS loss')
...
optim_l = optim.AdamW(model.l.parameters(), lr=learning_rate, weight_decay=0.01)
optim_r = optim.AdamW(model.r.parameters(), lr=learning_rate, weight_decay=0.01)

lr_scheduler_l = optim.lr_scheduler.PolynomialLR(optim_l, power=0.9, total_iters=num_epochs)
lr_scheduler_r = optim.lr_scheduler.PolynomialLR(optim_r, power=0.9, total_iters=num_epochs)
