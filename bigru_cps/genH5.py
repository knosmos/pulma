...
from dataset_gen import load_sample, load_sample_combined
import os
import glob
import numpy as np
...
def genH5():
    ...
    for filename in tqdm(sorted(files)):
        ...
        labels, data = load_sample_combined(filename)
        accdata.append(data)
        acclabels.append(labels)
        #print('.', end='', flush=True)
    save_h5('train_steth_combined.h5', accdata, acclabels, accfilenames)
    ...
    for filename in tqdm(sorted(files)):
        ...
        acclabels.append(labels)
        #print('.', end='', flush=True)
    save_h5('test_steth_combined.h5', accdata, acclabels, accfilenames)
