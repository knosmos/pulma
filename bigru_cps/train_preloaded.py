...
from models import TwinNetworkGRU
import people_split
#import librosa
...
optim_backbone = optim.AdamW(model.backbone.parameters(), lr=args.lr, weight_decay=0.01)
...
lr_scheduler_backbone = optim.lr_scheduler.PolynomialLR(optim_backbone, power=0.9, total_iters=args.epochs)
