...
class TwinNetwork(nn.Module):
    def __init__(self, input_size, num_classes, device):
        ...
        self.l = Cnn14_8k_original(sample_rate=8000, window_size=256, hop_size=80, mel_bins=64, fmin=50, fmax=4000, classes_num=6)
        self.r = Cnn14_8k_original(sample_rate=8000, window_size=256, hop_size=80, mel_bins=64, fmin=50, fmax=4000, classes_num=6)
        self.device = device
        self.init_weights()
